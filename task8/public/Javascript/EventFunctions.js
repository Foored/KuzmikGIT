    ...
    exp.logButtonEvent = function logButtonEvent(logButton) {
        if(currentUser.name === '') {
            eventsModule.showLoginPage();
    ...
    exp.showMainPage = function showMainPage(username) {
        ...
        logButton.onclick = function () {
            eventsModule.logButtonEvent(logButton);
        };
    ...
    exp.authorization = function authorization(){
        ...
        if(loginInput.value !=='' && passwordInput.value !=='')
            eventsModule.showMainPage(loginInput.value);
        else {
    ...
    exp.pressLike = function pressLike(id) {
        if(currentUser.name==='')
            return;
    ...
    exp.editPost = function editPost(id) {
        ...
        doneButton.onclick = function () {
            ...
            if(modulePhotoPosts.editPhotoPost(photoPost.id, {hashtags: hashtagsArray, description: editPanelD.value})) {
                ...
                localStorageModule.addArrayToLS();
                eventsModule.showMainPage(currentUser.name);
            }
        };
